...
struct _GtkDial
{
  ...
  /* Whether the user is able to edit the dial value */
  guint view_only : 1;
  ...
  /* The unit to diplay under the dial */
  gchar *unit;
};
...
GtkWidget*	gtk_dial_new (const char *name,
...
void           gtk_dial_set_view_only          (GtkDial         *dial,
                                                gboolean        view_only);
void           gtk_dial_set_unit               (GtkDial         *dial,
                                                gchar           *unit);
